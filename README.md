...
<!-- Replace this section with self-contained, runnable examples as features land. -->

Version 2 is a ground-up redesign and its public API is not yet implemented.
For now, only the package itself can be imported:
